        ...
        <div class="p-6">
            ...
            <div class="flex justify-between pr-12">
                <div class="transaction-detail">
                    ...
                    <h3 class="text-gray-600">Hi <b>{{ Auth::user()->name }}</b>, <br> Terimakasih Telah Berbelanja</h3>
            ...
            <div class="back flex justify-center mt-12" id="back-to-home">
                <a href="{{ route('cart.take') }}" class="bg-[#003034] text-white font-semibold px-4 py-2">Back To Home</a>
            </div>
        </div>
